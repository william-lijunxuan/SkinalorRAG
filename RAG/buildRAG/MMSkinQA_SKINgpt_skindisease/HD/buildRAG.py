...
from config import CSV_PATH_MMSkinQA,JSON_PATH_SKINgpt, IMAGE_DIR_SKINgpt,IMAGE_DIR_MMSkinQA, CHROMA_PERSIST_PATH, CHROMA_COLLECTION_NAME, EMBEDDING_MODEL_NAME
...
def main():
    ...
    try:
        ...
        df = pd.concat([SKINgpt_df, MMSkinQA_df], ignore_index=True)
